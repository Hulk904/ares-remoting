...
public class RevokerFactoryBean implements FactoryBean, InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        //获取服务提供者代理对象
        RevokerProxyBeanFactory proxyFactory =new RevokerProxyBeanFactory(targetInterface,timeout,clusterStrategy);// RevokerProxyBeanFactory.singleton(targetInterface, timeout, clusterStrategy);
